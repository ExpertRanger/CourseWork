...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox_B
			// 
			this->textBox_B->BackColor = System::Drawing::SystemColors::Info;
			...
			// textBox_C
			// 
			this->textBox_C->BackColor = System::Drawing::SystemColors::Info;
			...
			// label_answer
			// 
			this->label_answer->BackColor = System::Drawing::Color::BlanchedAlmond;
			...
			// label_main
			// 
			this->label_main->BackColor = System::Drawing::Color::BlanchedAlmond;
			...
			// label_podbor
			// 
			this->label_podbor->BackColor = System::Drawing::Color::BlanchedAlmond;
			...
			this->Text = L"Приложения для вычисления корней квадратного уравнения";
